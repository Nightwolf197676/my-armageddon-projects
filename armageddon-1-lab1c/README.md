...
- copy [Logan's Armageddon](https://github.com/DennistonShaw/armageddon-class7-LT#) in Github
- clone it to your local
- create a new folder and copy his files from Lab 1c - Bonus A into your newly created folder
- copy your README file, and any snapshots/screen captures from your old folder into the new folder as well
