...
variable "sns_email_endpoint" {
  ...
  type        = string
  default     = "southrakkasmedia@gmail.com" # TODO: student supplies
}
...
variable "cloudfront_acm_cert_arn" {
  description = "ACM certificate ARN in us-east-1 for CloudFront (covers southrakkasmedia.com and app.southrakkasmedia.com)."
  type        = string
  default     = ""
}